...
```{r chunk25}
Auto <- read.table("../X00_Data/Auto.data")
...
```{r chunk26}
Auto <- read.table("../X00_Data/Auto.data", header = T, na.strings = "?", stringsAsFactors = T)
...
```{r chunk27}
Auto <- read.csv("../X00_Data/Auto.csv", na.strings = "?", stringsAsFactors = T)
head(Auto)
dim(Auto)
Auto[1:4, ]
```
